...
const EmarsysInitializationTagData = `___INFO___
...
const sessionId = getCookieValues('emarsys_s')[0] || null;
const visitorId = getCookieValues('emarsys_cdv')[0] || null;
const pageViewId = generateRandom(0, Math.pow(2, 31));
